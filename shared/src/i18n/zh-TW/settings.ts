...
const settings: TranslationStrings = {
  ...
  'settings.notificationPreferences.webpush': '推播',
  'settings.webPush.title': 'Web Push 裝置',
  'settings.webPush.description': '即使 TREK 已關閉，也可透過此瀏覽器接收 TREK 通知。',
  'settings.webPush.enable': '在此裝置啟用推播',
  'settings.webPush.enabling': '正在啟用…',
  'settings.webPush.adminDisabled': '管理員目前已停用 Web Push。',
  'settings.webPush.unavailable': '此 TREK 安裝無法使用 Web Push。',
  'settings.webPush.unsupported': '此瀏覽器不支援 Web Push。',
  'settings.webPush.denied': '通知已遭封鎖。請在瀏覽器或裝置設定中允許通知。',
  'settings.webPush.iosInstall': '請先將 TREK 加入主畫面，再於 iPhone 或 iPad 上啟用推播通知。',
  'settings.webPush.current': '此裝置',
  'settings.webPush.lastSeen': '上次使用：{date}',
  'settings.webPush.neverDelivered': '尚無成功傳送紀錄',
  'settings.webPush.lastDelivered': '上次傳送：{date}',
  'settings.webPush.rename': '重新命名',
  'settings.webPush.revoke': '撤銷',
  'settings.webPush.test': '傳送測試',
  'settings.webPush.renamePrompt': '裝置名稱',

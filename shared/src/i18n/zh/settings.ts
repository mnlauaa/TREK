...
const settings: TranslationStrings = {
  ...
  'settings.notificationPreferences.webpush': '推送',
  'settings.webPush.title': 'Web Push 设备',
  'settings.webPush.description': '即使 TREK 已关闭，也可通过此浏览器接收 TREK 通知。',
  'settings.webPush.enable': '在此设备启用推送',
  'settings.webPush.enabling': '正在启用…',
  'settings.webPush.adminDisabled': '管理员当前已禁用 Web Push。',
  'settings.webPush.unavailable': '此 TREK 安装无法使用 Web Push。',
  'settings.webPush.unsupported': '此浏览器不支持 Web Push。',
  'settings.webPush.denied': '通知已被阻止。请在浏览器或设备设置中允许通知。',
  'settings.webPush.iosInstall': '请先将 TREK 添加到主屏幕，再在 iPhone 或 iPad 上启用推送通知。',
  'settings.webPush.current': '此设备',
  'settings.webPush.lastSeen': '上次使用：{date}',
  'settings.webPush.neverDelivered': '尚无成功发送记录',
  'settings.webPush.lastDelivered': '上次发送：{date}',
  'settings.webPush.rename': '重命名',
  'settings.webPush.revoke': '撤销',
  'settings.webPush.test': '发送测试',
  'settings.webPush.renamePrompt': '设备名称',
  'settings.webPush.enabled': '已在此设备启用推送通知。',
  'settings.webPush.revoked': '已撤销设备。',
  'settings.webPush.notNow': '暂不',

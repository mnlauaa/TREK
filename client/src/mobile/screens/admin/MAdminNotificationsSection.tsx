    ...
    <div className="space-y-3">
        ...
        <MAdminCardHead
          ...
          trailing={
            <MToggle
              ...
              onChange={() => setChannels(!emailActive, webhookActive, ntfyActive, webPushActive)}
            />
          }
        />
      ...
      <MAdminCard>
        <MAdminCardHead
          ...
          hint={t('settings.webPush.description')}
          trailing={
            <MToggle
              checked={webPushActive}
              ariaLabel={t('settings.webPush.title')}
              onChange={() => setChannels(emailActive, webhookActive, ntfyActive, !webPushActive)}
            />
          }
        />

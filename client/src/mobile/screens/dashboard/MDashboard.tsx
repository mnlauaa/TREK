...
import {
  type DashboardTrip,
  type DepartureTransport,
  MS_PER_DAY,
  daysUntil,
  getTripStatus,
} from '../../../pages/dashboard/dashboardModel';
import DepartureCountdownBoard from '../../../pages/dashboard/DepartureCountdownBoard';
...
function MSpotlightCard({
  ...
  trip: DashboardTrip;
  departure: DepartureTransport | null;
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[10px] left-[10px] right-[10px] rounded-[18px] border border-white/[.16] bg-[rgba(14,14,17,.52)] p-[12px_14px] text-white backdrop-blur-[22px] backdrop-saturate-[1.6]">
        ...
        {departure && <DepartureCountdownBoard departure={departure} compact />}
      </div>
    </div>
  );
}

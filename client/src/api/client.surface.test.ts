...
describe('client > endpoint wiring', () => {
  it('FE-APISURF-001: authApi maps every method to its auth endpoint', async () => {
    await assertCalls([
      ...
      {
        n: 'verifyMfaLogin',
        r: () => authApi.verifyMfaLogin({ mfa_token: 'm', code: '123456' }),
        e: 'POST /api/auth/mfa/verify-login',
      },
      ...
      {
        n: 'mfaDisable',
        r: () => authApi.mfaDisable({ password: 'pw', code: '123456' }),
        e: 'POST /api/auth/mfa/disable',
      },
      ...
      {
        n: 'updateAppSettings',
        r: () => authApi.updateAppSettings({ registration_enabled: true }),
        e: 'PUT /api/auth/app-settings',
      },
      ...
      {
        n: 'changePassword',
        r: () => authApi.changePassword({ current_password: 'a', new_password: 'b' }),
        e: 'PUT /api/auth/me/password',
      },
      { n: 'forgotPassword', r: () => authApi.forgotPassword({ email: 'a@b.c' }), e: 'POST /api/auth/forgot-password' },
      {
        n: 'resetPassword',
        r: () => authApi.resetPassword({ token: 't', new_password: 'b' }),
      ...
      {
        n: 'passkey.registerOptions',
        r: () => authApi.passkey.registerOptions('pw'),
        e: 'POST /api/auth/passkey/register/options',
      },
      {
        n: 'passkey.registerVerify',
        r: () => authApi.passkey.registerVerify({ id: 'cred' }, 'Yubikey'),
        e: 'POST /api/auth/passkey/register/verify',
      },
      { n: 'passkey.loginOptions', r: () => authApi.passkey.loginOptions(), e: 'POST /api/auth/passkey/login/options' },
      {
        n: 'passkey.loginVerify',
        r: () => authApi.passkey.loginVerify({ id: 'cred' }),
        e: 'POST /api/auth/passkey/login/verify',
      },
  ...
  it('FE-APISURF-002: oauthApi maps consent + client/session management endpoints', async () => {
    ...
    await assertCalls([
      ...
      {
        n: 'clients.create',
        r: () => oauthApi.clients.create({ name: 'App', allowed_scopes: ['trips:read'] }),
        e: 'POST /api/oauth/clients',
      },
  ...
  it('FE-APISURF-004: daysApi and dayNotesApi map their nested trip endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'days.updateTransport',
        r: () => daysApi.updateTransport(1, 2, 'car'),
        e: 'PUT /api/trips/1/days/2/transport',
      },
      ...
      {
        n: 'dayNotes.create',
        r: () => dayNotesApi.create(1, 2, { text: 'note' }),
        e: 'POST /api/trips/1/days/2/notes',
      },
      {
        n: 'dayNotes.update',
        r: () => dayNotesApi.update(1, 2, 5, { text: 'edit' }),
        e: 'PUT /api/trips/1/days/2/notes/5',
      },
  ...
  it('FE-APISURF-005: placesApi maps CRUD, rating and list-import endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'importGoogleList',
        r: () => placesApi.importGoogleList(1, 'https://maps.app/x'),
        e: 'POST /api/trips/1/places/import/google-list',
      },
      {
        n: 'importNaverList',
        r: () => placesApi.importNaverList(1, 'https://naver/x'),
        e: 'POST /api/trips/1/places/import/naver-list',
      },
      { n: 'bulkDelete', r: () => placesApi.bulkDelete(1, [5, 6]), e: 'POST /api/trips/1/places/bulk-delete' },
      {
        n: 'bulkUpdate',
        r: () => placesApi.bulkUpdate(1, [5], { category_id: 2 }),
        e: 'POST /api/trips/1/places/bulk-update',
      },
    ]);
  });
  ...
  it('FE-APISURF-006: assignmentsApi maps day-plan endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'update',
        r: () => assignmentsApi.update(1, 2, 7, { notes: 'x' }),
        e: 'PUT /api/trips/1/days/2/assignments/7',
      },
      {
        n: 'getParticipants',
        r: () => assignmentsApi.getParticipants(1, 7),
        e: 'GET /api/trips/1/assignments/7/participants',
      },
      {
        n: 'setParticipants',
        r: () => assignmentsApi.setParticipants(1, 7, [4]),
        e: 'PUT /api/trips/1/assignments/7/participants',
      },
      {
        n: 'updateTime',
        r: () => assignmentsApi.updateTime(1, 7, { place_time: '09:00' }),
        e: 'PUT /api/trips/1/assignments/7/time',
      },
      {
        n: 'updateTransport',
        r: () => assignmentsApi.updateTransport(1, 7, null),
        e: 'PUT /api/trips/1/assignments/7/transport',
      },
    ]);
  });
  ...
  it('FE-APISURF-007: packingApi maps item, bag and template endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'bulkImport',
        r: () => packingApi.bulkImport(1, [{ name: 'Socks' }]),
        e: 'POST /api/trips/1/packing/import',
      },
      ...
      {
        n: 'setSharing',
        r: () => packingApi.setSharing(1, 4, { visibility: 'shared' }),
        e: 'PUT /api/trips/1/packing/4/sharing',
      },
      ...
      {
        n: 'removeContributor',
        r: () => packingApi.removeContributor(1, 4, 9),
        e: 'DELETE /api/trips/1/packing/4/contributors/9',
      },
      {
        n: 'getCategoryAssignees',
        r: () => packingApi.getCategoryAssignees(1),
        e: 'GET /api/trips/1/packing/category-assignees',
      },
      ...
      {
        n: 'saveAsTemplate',
        r: () => packingApi.saveAsTemplate(1, 'Beach'),
        e: 'POST /api/trips/1/packing/save-as-template',
      },
      {
        n: 'setBagMembers',
        r: () => packingApi.setBagMembers(1, 2, [9]),
        e: 'PUT /api/trips/1/packing/bags/2/members',
      },
  ...
  it('FE-APISURF-008: todoApi maps todo endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'getCategoryAssignees',
        r: () => todoApi.getCategoryAssignees(1),
        e: 'GET /api/trips/1/todo/category-assignees',
      },
    ]);
  });
  ...
  it('FE-APISURF-010: adminApi maps user, addon and settings endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'getPlacesAutocomplete',
        r: () => adminApi.getPlacesAutocomplete(),
        e: 'GET /api/admin/places-autocomplete',
      },
      {
        n: 'updatePlacesAutocomplete',
        r: () => adminApi.updatePlacesAutocomplete(true),
        e: 'PUT /api/admin/places-autocomplete',
      },
      ...
      {
        n: 'updateCollabFeatures',
        r: () => adminApi.updateCollabFeatures({ polls: true }),
        e: 'PUT /api/admin/collab-features',
      },
      { n: 'getPermissions', r: () => adminApi.getPermissions(), e: 'GET /api/admin/permissions' },
      {
        n: 'updatePermissions',
        r: () => adminApi.updatePermissions({ edit_trip: 'member' }),
        e: 'PUT /api/admin/permissions',
      },
      { n: 'rotateJwtSecret', r: () => adminApi.rotateJwtSecret(), e: 'POST /api/admin/rotate-jwt-secret' },
      {
        n: 'sendTestNotification',
        r: () => adminApi.sendTestNotification({ channel: 'email' }),
        e: 'POST /api/admin/dev/test-notification',
      },
      {
        n: 'getNotificationPreferences',
        r: () => adminApi.getNotificationPreferences(),
        e: 'GET /api/admin/notification-preferences',
      },
      {
        n: 'updateNotificationPreferences',
        r: () => adminApi.updateNotificationPreferences({ email: { trip_invite: true } }),
        e: 'PUT /api/admin/notification-preferences',
      },
      {
        n: 'getDefaultUserSettings',
        r: () => adminApi.getDefaultUserSettings(),
        e: 'GET /api/admin/default-user-settings',
      },
      {
        n: 'updateDefaultUserSettings',
        r: () => adminApi.updateDefaultUserSettings({ language: 'de' }),
        e: 'PUT /api/admin/default-user-settings',
      },
      { n: 'getStorage', r: () => adminApi.getStorage(), e: 'GET /api/admin/storage' },
      {
        n: 'updateStorage',
        r: () => adminApi.updateStorage({ backends: [], categories: {}, version: 0 }),
        e: 'PUT /api/admin/storage',
      },
      {
        n: 'testStorageBackend',
        r: () => adminApi.testStorageBackend({ name: 'x', type: 'local', options: { root: '/data' } }),
        e: 'POST /api/admin/storage/test',
      },
      {
        n: 'startStorageBackfill',
        r: () => adminApi.startStorageBackfill('m'),
        e: 'POST /api/admin/storage/backends/m/backfill',
      },
      {
        n: 'cancelStorageBackfill',
        r: () => adminApi.cancelStorageBackfill('m'),
        e: 'DELETE /api/admin/storage/backends/m/backfill',
      },
      {
        n: 'startStorageMigration',
        r: () => adminApi.startStorageMigration('files', 'dest'),
        e: 'POST /api/admin/storage/migrations',
      },
      {
        n: 'cancelStorageMigration',
        r: () => adminApi.cancelStorageMigration('files'),
        e: 'DELETE /api/admin/storage/migrations/files',
      },
  ...
  it('FE-APISURF-011: adminApi maps the plugin management endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'pluginDetail',
        r: () => adminApi.pluginDetail('trek/koffi'),
        e: 'GET /api/admin/plugins/registry/trek%2Fkoffi',
      },
      {
        n: 'pluginInstall',
        r: () => adminApi.pluginInstall('koffi', { version: '1.0.0' }),
        e: 'POST /api/admin/plugins/install',
      },
      { n: 'pluginActivate', r: () => adminApi.pluginActivate('koffi'), e: 'POST /api/admin/plugins/koffi/activate' },
      {
        n: 'pluginDeactivate',
        r: () => adminApi.pluginDeactivate('koffi'),
        e: 'POST /api/admin/plugins/koffi/deactivate',
      },
      { n: 'pluginUpdate', r: () => adminApi.pluginUpdate('koffi'), e: 'POST /api/admin/plugins/koffi/update' },
      {
        n: 'pluginRetrust',
        r: () => adminApi.pluginRetrust('koffi', '2.0.0', 'PUBKEY'),
        e: 'POST /api/admin/plugins/koffi/retrust',
      },
      {
        n: 'pluginUninstall',
        r: () => adminApi.pluginUninstall('koffi', true),
        e: 'POST /api/admin/plugins/koffi/uninstall',
      },
      ...
      {
        n: 'pluginSaveConfig',
        r: () => adminApi.pluginSaveConfig('koffi', { apiUrl: 'x' }),
        e: 'PUT /api/admin/plugins/koffi/config',
      },
      {
        n: 'runPluginAction',
        r: () => adminApi.runPluginAction('koffi', 'purge cache'),
        e: 'POST /api/admin/plugins/koffi/actions/purge%20cache',
      },
      {
        n: 'pluginEgressHosts',
        r: () => adminApi.pluginEgressHosts('koffi'),
        e: 'GET /api/admin/plugins/koffi/egress-hosts',
      },
      {
        n: 'pluginSetEgressHosts',
        r: () => adminApi.pluginSetEgressHosts('koffi', ['a.example']),
        e: 'PUT /api/admin/plugins/koffi/egress-hosts',
      },
      ...
      {
        n: 'llmLocalModels',
        r: () => adminApi.llmLocalModels('http://ollama:11434'),
        e: 'GET /api/admin/llm/local/models',
      },
    ]);
  });
  ...
  it('FE-APISURF-012: adminApi maps the packing-template endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'createPackingTemplate',
        r: () => adminApi.createPackingTemplate({ name: 'Ski' }),
        e: 'POST /api/admin/packing-templates',
      },
      {
        n: 'updatePackingTemplate',
        r: () => adminApi.updatePackingTemplate(1, { name: 'Ski 2' }),
        e: 'PUT /api/admin/packing-templates/1',
      },
      {
        n: 'deletePackingTemplate',
        r: () => adminApi.deletePackingTemplate(1),
        e: 'DELETE /api/admin/packing-templates/1',
      },
      {
        n: 'addTemplateCategory',
        r: () => adminApi.addTemplateCategory(1, { name: 'Clothes' }),
        e: 'POST /api/admin/packing-templates/1/categories',
      },
      {
        n: 'updateTemplateCategory',
        r: () => adminApi.updateTemplateCategory(1, 2, { name: 'Wear' }),
        e: 'PUT /api/admin/packing-templates/1/categories/2',
      },
      {
        n: 'deleteTemplateCategory',
        r: () => adminApi.deleteTemplateCategory(1, 2),
        e: 'DELETE /api/admin/packing-templates/1/categories/2',
      },
      {
        n: 'addTemplateItem',
        r: () => adminApi.addTemplateItem(1, 2, { name: 'Gloves' }),
        e: 'POST /api/admin/packing-templates/1/categories/2/items',
      },
      {
        n: 'updateTemplateItem',
        r: () => adminApi.updateTemplateItem(1, 3, { name: 'Mittens' }),
        e: 'PUT /api/admin/packing-templates/1/items/3',
      },
      {
        n: 'deleteTemplateItem',
        r: () => adminApi.deleteTemplateItem(1, 3),
        e: 'DELETE /api/admin/packing-templates/1/items/3',
      },
    ]);
  });
  ...
  it('FE-APISURF-013: pluginsApi maps every host-mediated plugin endpoint', async () => {
    await assertCalls([
      ...
      {
        n: 'viewContributions',
        r: () => pluginsApi.viewContributions('places', 1),
        e: 'GET /api/view-contributions/places/1',
      },
      ...
      {
        n: 'pluginRoute',
        r: () => pluginsApi.pluginRoute('koffi', 'ev', { tripId: 1, waypoints: [{ lat: 1, lng: 2 }] }),
        e: 'POST /api/plugin-routes/koffi/ev',
      },
      ...
      {
        n: 'tripCardContributions',
        r: () => pluginsApi.tripCardContributions([1, 2]),
        e: 'GET /api/trip-card-contributions',
      },
      ...
      {
        n: 'runAction',
        r: () => pluginsApi.runAction('koffi', 'test connection'),
        e: 'POST /api/plugin-settings/koffi/actions/test%20connection',
      },
      {
        n: 'saveUserSettings',
        r: () => pluginsApi.saveUserSettings('koffi', { key: 'v' }),
        e: 'POST /api/plugin-settings/koffi',
      },
      ...
      {
        n: 'oauthDisconnect',
        r: () => pluginsApi.oauthDisconnect('koffi'),
        e: 'POST /api/plugin-oauth/koffi/disconnect',
      },
    ]);
  });
  ...
  it('FE-APISURF-014: airtrailApi maps the integration endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'saveSettings',
        r: () => airtrailApi.saveSettings({ url: 'https://at' }),
        e: 'PUT /api/integrations/airtrail/settings',
      },
  ...
  it('FE-APISURF-015: journeyApi maps journal, entry and photo endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'addProviderPhotosToGallery',
        r: () => journeyApi.addProviderPhotosToGallery(2, 'immich', ['a1']),
        e: 'POST /api/journeys/2/gallery/provider-photos',
      },
      {
        n: 'addProviderPhoto',
        r: () => journeyApi.addProviderPhoto(9, 'immich', 'a1'),
        e: 'POST /api/journeys/entries/9/provider-photos',
      },
      {
        n: 'addProviderPhotos',
        r: () => journeyApi.addProviderPhotos(9, 'immich', ['a1']),
        e: 'POST /api/journeys/entries/9/provider-photos',
      },
      ...
      {
        n: 'deleteGalleryPhoto',
        r: () => journeyApi.deleteGalleryPhoto(2, 11),
        e: 'DELETE /api/journeys/2/gallery/11',
      },
      ...
      {
        n: 'addContributor',
        r: () => journeyApi.addContributor(2, 4, 'editor'),
        e: 'POST /api/journeys/2/contributors',
      },
      {
        n: 'updateContributor',
        r: () => journeyApi.updateContributor(2, 4, 'viewer'),
        e: 'PATCH /api/journeys/2/contributors/4',
      },
      {
        n: 'removeContributor',
        r: () => journeyApi.removeContributor(2, 4),
        e: 'DELETE /api/journeys/2/contributors/4',
      },
      {
        n: 'updatePreferences',
        r: () => journeyApi.updatePreferences(2, { hide_skeletons: true }),
        e: 'PATCH /api/journeys/2/preferences',
      },
      { n: 'getShareLink', r: () => journeyApi.getShareLink(2), e: 'GET /api/journeys/2/share-link' },
      {
        n: 'createShareLink',
        r: () => journeyApi.createShareLink(2, { share_map: true }),
        e: 'POST /api/journeys/2/share-link',
      },
  ...
  it('FE-APISURF-053: memoriesApi maps the photo-provider endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'search',
        r: () => memoriesApi.search('immich', { from: '2026-01-01', to: '2026-01-02', page: 1, size: 50 }),
        e: 'POST /api/integrations/memories/immich/search',
      },
      { n: 'albums', r: () => memoriesApi.albums('immich'), e: 'GET /api/integrations/memories/immich/albums' },
      {
        n: 'albumPhotos',
        r: () => memoriesApi.albumPhotos('immich', 'alb-1'),
        e: 'GET /api/integrations/memories/immich/albums/alb-1/photos',
      },
    ]);
  });
  ...
  it('FE-APISURF-016: mapsApi and airportsApi map the geo endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'maps.resolveUrl',
        r: () => mapsApi.resolveUrl('https://maps.app.goo.gl/x'),
        e: 'POST /api/maps/resolve-url',
      },
      {
        n: 'maps.pois',
        r: () => mapsApi.pois('cafe', { south: 1, west: 2, north: 3, east: 4 }),
        e: 'GET /api/maps/pois',
      },
  ...
  it('FE-APISURF-017: budgetApi maps item, member and settlement endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'setPayers',
        r: () => budgetApi.setPayers(1, 2, [{ user_id: 4, amount: 10 }]),
        e: 'PUT /api/trips/1/budget/2/payers',
      },
      {
        n: 'perPersonSummary',
        r: () => budgetApi.perPersonSummary(1),
        e: 'GET /api/trips/1/budget/summary/per-person',
      },
      { n: 'settlement', r: () => budgetApi.settlement(1), e: 'GET /api/trips/1/budget/settlement' },
      {
        n: 'createSettlement',
        r: () => budgetApi.createSettlement(1, { from_user_id: 4, to_user_id: 5, amount: 10 }),
        e: 'POST /api/trips/1/budget/settlements',
      },
      {
        n: 'updateSettlement',
        r: () => budgetApi.updateSettlement(1, 6, { from_user_id: 4, to_user_id: 5, amount: 12 }),
        e: 'PUT /api/trips/1/budget/settlements/6',
      },
      {
        n: 'deleteSettlement',
        r: () => budgetApi.deleteSettlement(1, 6),
        e: 'DELETE /api/trips/1/budget/settlements/6',
      },
      { n: 'reorderItems', r: () => budgetApi.reorderItems(1, [2, 3]), e: 'PUT /api/trips/1/budget/reorder/items' },
      {
        n: 'reorderCategories',
        r: () => budgetApi.reorderCategories(1, ['Food']),
        e: 'PUT /api/trips/1/budget/reorder/categories',
      },
    ]);
  });
  ...
  it('FE-APISURF-019: reservationsApi and accommodationsApi map booking endpoints', async () => {
    await assertCalls([
      ...
      { n: 'reservations.upcoming', r: () => reservationsApi.upcoming(), e: 'GET /api/reservations/upcoming' },
      {
        ...
        r: () => reservationsApi.create(1, { title: 'Hotel' }),
        e: 'POST /api/trips/1/reservations',
      },
      {
        n: 'reservations.update',
        r: () => reservationsApi.update(1, 2, { title: 'Hostel' }),
        e: 'PUT /api/trips/1/reservations/2',
      },
      { n: 'reservations.delete', r: () => reservationsApi.delete(1, 2), e: 'DELETE /api/trips/1/reservations/2' },
      {
        n: 'reservations.setTravelers',
        r: () => reservationsApi.setTravelers(1, 2, [4]),
        e: 'PUT /api/trips/1/reservations/2/travelers',
      },
      {
        n: 'reservations.updatePositions',
        r: () => reservationsApi.updatePositions(1, [{ id: 2, day_plan_position: 0 }], 3),
        e: 'PUT /api/trips/1/reservations/positions',
      },
      {
        n: 'reservations.importBookingConfirm',
        r: () => reservationsApi.importBookingConfirm(1, []),
        e: 'POST /api/trips/1/reservations/import/booking/confirm',
      },
      {
        n: 'reservations.importJobStatus',
        r: () => reservationsApi.importJobStatus(1, 'job-1'),
        e: 'GET /api/trips/1/reservations/import/jobs/job-1',
      },
      { n: 'accommodations.list', r: () => accommodationsApi.list(1), e: 'GET /api/trips/1/accommodations' },
      {
        n: 'accommodations.create',
        r: () => accommodationsApi.create(1, { place_id: 5, start_day_id: 1, end_day_id: 2 }),
        e: 'POST /api/trips/1/accommodations',
      },
      {
        n: 'accommodations.update',
        r: () => accommodationsApi.update(1, 4, { end_day_id: 3 }),
        e: 'PUT /api/trips/1/accommodations/4',
      },
      {
        n: 'accommodations.delete',
        r: () => accommodationsApi.delete(1, 4),
        e: 'DELETE /api/trips/1/accommodations/4',
      },
    ]);
  });
  ...
  it('FE-APISURF-020: collabApi maps note, poll and message endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'deleteNoteFile',
        r: () => collabApi.deleteNoteFile(1, 2, 3),
        e: 'DELETE /api/trips/1/collab/notes/2/files/3',
      },
      { n: 'getPolls', r: () => collabApi.getPolls(1), e: 'GET /api/trips/1/collab/polls' },
      {
        n: 'createPoll',
        r: () => collabApi.createPoll(1, { question: 'Where?', options: ['A', 'B'] }),
        e: 'POST /api/trips/1/collab/polls',
      },
      ...
      {
        n: 'reactMessage',
        r: () => collabApi.reactMessage(1, 2, '👍'),
        e: 'POST /api/trips/1/collab/messages/2/react',
      },
      {
        n: 'linkPreview',
        r: () => collabApi.linkPreview(1, 'https://x.test/a?b=1'),
        e: 'GET /api/trips/1/collab/link-preview',
      },
    ]);
  });
  ...
  it('FE-APISURF-021: the remaining namespaces map their endpoints', async () => {
    await assertCalls([
      ...
      {
        n: 'weather.getDetailed',
        r: () => weatherApi.getDetailed(41.9, 12.5, '2026-06-01'),
        e: 'GET /api/weather/detailed',
      },
      ...
      {
        n: 'settings.reset',
        r: () => settingsApi.reset('common_currencies'),
        e: 'DELETE /api/settings/common_currencies',
      },
      ...
      {
        n: 'backup.setAutoSettings',
        r: () => backupApi.setAutoSettings({ enabled: true }),
        e: 'PUT /api/backup/auto-settings',
      },
      ...
      {
        n: 'notifications.getPreferences',
        r: () => notificationsApi.getPreferences(),
        e: 'GET /api/notifications/preferences',
      },
      {
        n: 'notifications.updatePreferences',
        r: () => notificationsApi.updatePreferences({ email: { trip_invite: true } }),
        e: 'PUT /api/notifications/preferences',
      },
      {
        n: 'notifications.testSmtp',
        r: () => notificationsApi.testSmtp('a@b.c'),
        e: 'POST /api/notifications/test-smtp',
      },
      {
        n: 'notifications.testWebhook',
        r: () => notificationsApi.testWebhook('https://hook'),
        e: 'POST /api/notifications/test-webhook',
      },
      {
        n: 'notifications.testNtfy',
        r: () => notificationsApi.testNtfy({ topic: 't' }),
        e: 'POST /api/notifications/test-ntfy',
      },
      {
        n: 'notifications.testChannel',
        r: () => notificationsApi.testChannel('plugin/ch'),
        e: 'POST /api/notifications/test/plugin%2Fch',
      },
      { n: 'inApp.list', r: () => inAppNotificationsApi.list(), e: 'GET /api/notifications/in-app' },
      {
        n: 'inApp.unreadCount',
        r: () => inAppNotificationsApi.unreadCount(),
        e: 'GET /api/notifications/in-app/unread-count',
      },
      { n: 'inApp.markRead', r: () => inAppNotificationsApi.markRead(3), e: 'PUT /api/notifications/in-app/3/read' },
      {
        n: 'inApp.markUnread',
        r: () => inAppNotificationsApi.markUnread(3),
        e: 'PUT /api/notifications/in-app/3/unread',
      },
      {
        n: 'inApp.markAllRead',
        r: () => inAppNotificationsApi.markAllRead(),
        e: 'PUT /api/notifications/in-app/read-all',
      },
      ...
      {
        n: 'inApp.respond',
        r: () => inAppNotificationsApi.respond(3, 'positive'),
        e: 'POST /api/notifications/in-app/3/respond',
      },
    ]);
  });
});
...
describe('client > request payloads', () => {
  it('FE-APISURF-022: reorder helpers wrap their ids in the contract field', async () => {
    ...
    expect((await traceOne(() => budgetApi.reorderCategories(1, ['Food', 'Fun']))).body).toEqual({
      orderedCategories: ['Food', 'Fun'],
    });
  ...
  it('FE-APISURF-024: single-value helpers wrap their argument in the documented key', async () => {
    ...
    expect((await traceOne(() => adminApi.updatePermissions({ edit: 'owner' }))).body).toEqual({
      permissions: { edit: 'owner' },
    });
    expect((await traceOne(() => pluginsApi.saveUserSettings('koffi', { k: 'v' }))).body).toEqual({
      config: { k: 'v' },
    });
  });
  ...
  it('FE-APISURF-026: placesApi bulk operations merge ids with the patch', async () => {
    ...
    expect((await traceOne(() => placesApi.bulkUpdate(1, [5], { category_id: null }))).body).toEqual({
      ids: [5],
      category_id: null,
    });
  });
  ...
  it('FE-APISURF-028: airtrailApi.import only sends connections when there are any', async () => {
    ...
    expect((await traceOne(() => airtrailApi.import(1, ['f1', 'f2'], [['f1', 'f2']]))).body).toEqual({
      flightIds: ['f1', 'f2'],
      connections: [['f1', 'f2']],
    });
  });
  ...
  it('FE-APISURF-029: journeyApi provider-photo calls omit optional passphrase and media types', async () => {
    expect((await traceOne(() => journeyApi.addProviderPhotosToGallery(2, 'immich', ['a1']))).body).toEqual({
      provider: 'immich',
      asset_ids: ['a1'],
    });
    expect(
      (await traceOne(() => journeyApi.addProviderPhotosToGallery(2, 'immich', ['a1'], 'secret', ['video']))).body
    ).toEqual({ provider: 'immich', asset_ids: ['a1'], passphrase: 'secret', media_types: ['video'] });
    expect((await traceOne(() => journeyApi.addProviderPhoto(9, 'immich', 'a1', 'cap', 'secret'))).body).toEqual({
      provider: 'immich',
      asset_id: 'a1',
      caption: 'cap',
      passphrase: 'secret',
    });
    expect((await traceOne(() => journeyApi.addProviderPhotos(9, 'immich', ['a1'], 'cap'))).body).toEqual({
      provider: 'immich',
      asset_ids: ['a1'],
      caption: 'cap',
    });
    expect(
      (await traceOne(() => journeyApi.addProviderPhotos(9, 'immich', ['a1'], 'cap', 'secret', ['image', 'video'])))
        .body
    ).toEqual({
      provider: 'immich',
      asset_ids: ['a1'],
  ...
  it('FE-APISURF-031: adminApi.pluginInstall spreads its options next to the id', async () => {
    ...
    expect(
      (await traceOne(() => adminApi.pluginInstall('koffi', { version: '2.0.0', withDependencies: true }))).body
...
describe('client > query parameters', () => {
  ...
  it('FE-APISURF-038: collabApi.getMessages appends the before cursor', async () => {
    ...
    expect((await traceOne(() => collabApi.getMessages(1, '2026-01-01'))).url).toBe(
      '/api/trips/1/collab/messages?before=2026-01-01'
    );
  });
  ...
  it('FE-APISURF-043: pluginsApi joins trip ids and defaults the activity limit', async () => {
    expect((await traceOne(() => pluginsApi.tripCardContributions([1, 2, 3]))).url).toBe(
      '/api/trip-card-contributions?tripIds=1,2,3'
    );
...
describe('client > multipart uploads', () => {
  ...
  function spyPost() {
    return vi.spyOn(apiClient, 'post').mockResolvedValue({ data: { ok: true } } as unknown as AxiosResponse);
  }
